...
#if defined(SYNC)
#define SYNC_COMMON
const byte SYNC1_PIN =            11;
const byte SYNC1_TRIGGER =        HIGH;
const byte SYNC2_PIN =            12;
...
const byte DEPTH1_KNOB_PIN =        1;

const byte FREQ2_KNOB_PIN =         2;
const byte DEPTH2_KNOB_PIN =        3;

// SWITCHES (digital pins)

const byte WAVE1_SWITCH_PIN =      3;
const byte WAVE2_SWITCH_PIN =      2;

// LFO SETTINGS
const double LFO1_FREQ_MIN =      0.1;
const double LFO1_FREQ_MAX =      50;

const double LFO2_FREQ_MIN =      0.1;
const double LFO2_FREQ_MAX =      50;
